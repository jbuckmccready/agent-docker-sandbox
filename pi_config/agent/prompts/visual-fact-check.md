...
**Phase 5: Report.** Tell the user what was checked, what was corrected, and tell the user the file path. If nothing needed correction, say so — the verification still has value as confirmation.
