...
**Output location:** Write to `./.pi/visual-explainer/`. Use a descriptive filename based on content: `modem-architecture.html`, `pipeline-flow.html`, `schema-overview.html`.
